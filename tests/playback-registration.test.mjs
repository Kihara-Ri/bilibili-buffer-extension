...
test('生产 MAIN world 注册缓存在观察器之前，版本与检查命令一致', async () => {
  ...
  assert.deepEqual(main.js, ['src/playback-cache.js', 'src/playback-routes.js', 'src/playback-network.js', 'src/request-budget-client.js', 'src/playback-reuse.js', 'src/playback-observer.js']);
